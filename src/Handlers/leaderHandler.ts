...
export class LeaderHandler  {
    isClient(data: any, sock: Socket): Promise<boolean> {
        return LeaderService.checkClientExists(data, sock);
    }
    isChatroom(data: any, sock: Socket): Promise<boolean> {
    ...
    informRoomDeletion(data: any, sock: Socket): Promise<boolean> {
        return LeaderService.acknowledgeChatroomDeletion(data, sock);
    }
    informClientDeletion(data: any, sock: Socket): Promise<boolean> {
